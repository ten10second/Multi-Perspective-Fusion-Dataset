...
class opts(object):
  def __init__(self):
    ...
    # 05.10
    self.parser.add_argument('--perspective', default='bev',
                             help='bev' 'fpv')
    self.parser.add_argument('--output_format', default='video')
    self.parser.add_argument('--bev_results', default='../results/bev_results')
    self.parser.add_argument('--fpv_results', default='../results/fpv_results')
    # system
    ...
    self.parser.add_argument('--input_video', type=str,
                             default='../videos/2023_04_03/bev_folder/2023_04_03_sony_1.mp4',
                             help='path to the input video')
    self.parser.add_argument('--input_folder', type=str, 
                             default= '../videos/2023_04_03')
